...
def pruebaEVR():
    print('Ingrese el numero de puerto serial del banco de pruebas:\n')
    while True:
        try:
            numPort=input()
            ...
            if (intNumPort==int(numPort)):
                ...
                bancoEVR = serial.Serial('COM{}'.format(intNumPort),baudrate=9600,timeout=1)#se establece comunicacion serial, con el puerto COM, la velocidad de datos y el tiempo de espera
